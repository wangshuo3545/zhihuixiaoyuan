...
import CustomPage from './sub-page/components/custom/custom.vue'
import StagingPage from './sub-page/components/staging/staging.vue'
import MessagePage from './sub-page/components/message/message.vue'
import MyPage from './sub-page/components/my/my.vue'
...
// 底部导航栏数据
const tabbarData = [
  { text: '首页', icon: 'home-leaf-fill' },
  { text: '校友圈', icon: 'discover-fill' },
  { text: '消息', icon: 'comment-fill' },
  { text: '我的', icon: 'my-simple-fill' },
]
// 导航切换事件
